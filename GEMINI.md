...
4. **SOCRATIC RETURN** - after completing any sub-task, ask open question, give no hints
...
- **Root Files**:
  ...
  - `GEMINI.md`: Agent operational standards.
...
1. **Safety**: Analyze files before editing.
...
5. **Memory**: Update `Share_Memory.md` for learning progress. NEVER append code or lesson text to `Share_Memory.md`.
