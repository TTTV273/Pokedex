...
description: Cập nhật tiến độ học tập vào Share_Memory.md khi hoàn thành bài học. Use when user says "/update-progress", "cập nhật tiến độ", "ghi nhận bài học", or completes a lesson.
---
